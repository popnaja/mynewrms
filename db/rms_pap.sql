...
--
-- Host: localhost:3306
-- Generation Time: May 03, 2016 at 09:33 AM
...
CREATE TABLE `pap_customer_meta` (
  `id` int(10) UNSIGNED NOT NULL,
  `customer_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `pap_mat_delivery_dt` (
...
CREATE TABLE `pap_mat_po_detail` (
  `id` int(10) UNSIGNED NOT NULL,
  `po_id` int(10) UNSIGNED NOT NULL,
  `mat_id` int(10) UNSIGNED NOT NULL,
...
(2, 'role_auth', 'Observer', '{"customer.php":"4","term.php?tax=customer":"4","shipping_address.php":"4","quotation.php":"4","lay.php":"4","ac_schedule.php":"3","ac_bill.php":"3","ac_buy.php":"3","ac_credit.php":"3","order.php?d=ga":"3","order.php":"3","production.php":"3","status.php":"3","outsource.php":"3","outsource.php?action=viewpo":"3","index.php":"3","delivery.php":"3","process.php":"3","machine.php":"3","paper.php":"3","paper.php?action=viewpo":"3","mat.php":"3","supplier.php":"3","term.php?tax=supplier":"3","mat_received.php":"3","outsource_rc.php":"3","userinfo.php":"3","user.php":"0","role.php":"0","pap_option.php?type=product_cat":"0","pap_option.php?type=mat_cat":"0","process_cat.php":"0","pap_option.php?type=paper_allo":"0","pap_option.php?type=paper_type":"0","pap_option.php?type=paper_size":"0","pap_option.php?type=paper_weight":"0","setting.php":"0","upload.php":"0"}'),
...
(6, '11x21 cm', 21, 11, 18, 10, 20, 24, 1, 1, 1),
...
CREATE TABLE `pap_wip_delivery_dt` (
  `delivery_id` int(10) UNSIGNED NOT NULL,
  `dt_id` int(10) UNSIGNED NOT NULL,
  `qty` decimal(10,2) UNSIGNED NOT NULL,
  `stk_location` varchar(100) DEFAULT NULL
...
--
-- Indexes for table `pap_comp_process`
--
ALTER TABLE `pap_comp_process`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_comp_process_pap_order_comp1_idx` (`comp_id`),
  ADD KEY `fk_pap_comp_process_pap_process1_idx` (`process_id`);

--
-- Indexes for table `pap_contact`
--
ALTER TABLE `pap_contact`
  ADD PRIMARY KEY (`contact_id`),
  ADD KEY `fk_pap_contact_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_crm`
--
ALTER TABLE `pap_crm`
  ADD PRIMARY KEY (`crm_id`),
  ADD KEY `fk_pap_crm_pap_user1_idx` (`user_id`),
  ADD KEY `fk_pap_crm_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_customer`
--
ALTER TABLE `pap_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `pap_customer_cat`
--
ALTER TABLE `pap_customer_cat`
  ADD PRIMARY KEY (`tax_id`,`customer_id`),
  ADD KEY `fk_pap_customer_has_pap_term_tax_pap_term_tax1_idx` (`tax_id`),
  ADD KEY `fk_pap_customer_has_pap_term_tax_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_customer_meta`
--
ALTER TABLE `pap_customer_meta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_customer_meta_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_cus_ad`
--
ALTER TABLE `pap_cus_ad`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_cus_ad_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_delivery`
--
ALTER TABLE `pap_delivery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_delivery_pap_contact1_idx` (`contact`);

--
-- Indexes for table `pap_delivery_dt`
--
ALTER TABLE `pap_delivery_dt`
  ADD PRIMARY KEY (`deli_id`,`order_id`),
  ADD KEY `fk_pap_delivery_has_pap_order_pap_order1_idx` (`order_id`),
  ADD KEY `fk_pap_delivery_has_pap_order_pap_delivery1_idx` (`deli_id`);

--
-- Indexes for table `pap_invoice`
--
ALTER TABLE `pap_invoice`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_invoice_pap_customer1_idx` (`customer_id`),
  ADD KEY `fk_pap_invoice_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_invoice_dt`
--
ALTER TABLE `pap_invoice_dt`
  ADD PRIMARY KEY (`invoice_id`,`deli_id`),
  ADD KEY `fk_pap_invoice_has_pap_order_pap_invoice1_idx` (`invoice_id`),
  ADD KEY `fk_pap_invoice_dt_pap_delivery1_idx` (`deli_id`);

--
-- Indexes for table `pap_log`
--
ALTER TABLE `pap_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_log_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_machine`
--
ALTER TABLE `pap_machine`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_machine_pap_process1_idx` (`process_id`);

--
-- Indexes for table `pap_mach_user`
--
ALTER TABLE `pap_mach_user`
  ADD PRIMARY KEY (`user_id`,`mach_id`),
  ADD KEY `fk_pap_user_has_pap_machine_pap_machine1_idx` (`mach_id`),
  ADD KEY `fk_pap_user_has_pap_machine_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_mat`
--
ALTER TABLE `pap_mat`
  ADD PRIMARY KEY (`mat_id`),
  ADD KEY `fk_pap_mat_pap_option1_idx` (`mat_cat_id`);

--
-- Indexes for table `pap_matmeta`
--
ALTER TABLE `pap_matmeta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_matmeta_pap_mat1_idx` (`mat_id`);

--
-- Indexes for table `pap_mat_cost`
--
ALTER TABLE `pap_mat_cost`
  ADD PRIMARY KEY (`mat_id`,`supplier_id`),
  ADD KEY `fk_mat_has_pap_supplier_pap_supplier1_idx` (`supplier_id`),
  ADD KEY `fk_mat_has_pap_supplier_mat1_idx` (`mat_id`);

--
-- Indexes for table `pap_mat_delivery`
--
ALTER TABLE `pap_mat_delivery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_psp_mat_delivery_pap_mat_po1_idx` (`po_id`),
  ADD KEY `fk_pap_mat_delivery_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_mat_delivery_dt`
--
ALTER TABLE `pap_mat_delivery_dt`
  ADD PRIMARY KEY (`delivery_id`,`dt_id`),
  ADD KEY `fk_pap_mat_delivery_dt_pap_mat_delivery1_idx` (`delivery_id`),
  ADD KEY `fk_pap_mat_delivery_dt_pap_mat_po_detail1_idx` (`dt_id`);

--
-- Indexes for table `pap_mat_po`
--
ALTER TABLE `pap_mat_po`
  ADD PRIMARY KEY (`po_id`),
  ADD KEY `fk_pap_mat_po_pap_user1_idx` (`user_id`),
  ADD KEY `fk_pap_mat_po_pap_supplier1_idx` (`supplier_id`);

--
-- Indexes for table `pap_mat_po_detail`
--
ALTER TABLE `pap_mat_po_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_mat_po_has_pap_mat_cost_pap_mat_po1_idx` (`po_id`),
  ADD KEY `fk_pap_po_detail_pap_mat1_idx` (`mat_id`);

--
-- Indexes for table `pap_mat_stk`
--
ALTER TABLE `pap_mat_stk`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_mat_stk_pap_mat1_idx` (`mat_id`),
  ADD KEY `fk_pap_mat_stk_pap_mat_delivery1_idx` (`delivery_id`),
  ADD KEY `fk_pap_mat_stk_pap_requisition1_idx` (`req_id`);

--
-- Indexes for table `pap_option`
--
ALTER TABLE `pap_option`
  ADD PRIMARY KEY (`op_id`);

--
-- Indexes for table `pap_order`
--
ALTER TABLE `pap_order`
  ADD PRIMARY KEY (`order_id`),
  ADD KEY `fk_pap_order_pap_quotation1_idx` (`quote_id`);

--
-- Indexes for table `pap_order_comp`
--
ALTER TABLE `pap_order_comp`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_order_comp_pap_order1_idx` (`order_id`),
  ADD KEY `fk_pap_order_comp_pap_mat1_idx` (`paper_id`);

--
-- Indexes for table `pap_pbill`
--
ALTER TABLE `pap_pbill`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_pbill_pap_contact1_idx` (`contact`),
  ADD KEY `fk_pap_pbill_pap_customer1_idx` (`customer_id`);

--
-- Indexes for table `pap_pbill_dt`
--
ALTER TABLE `pap_pbill_dt`
  ADD PRIMARY KEY (`pbill_id`,`deli_id`),
  ADD KEY `fk_pap_pbill_has_pap_delivery_pap_delivery1_idx` (`deli_id`),
  ADD KEY `fk_pap_pbill_has_pap_delivery_pap_pbill1_idx` (`pbill_id`);

--
-- Indexes for table `pap_process`
--
ALTER TABLE `pap_process`
  ADD PRIMARY KEY (`process_id`),
  ADD UNIQUE KEY `process_name_UNIQUE` (`process_name`),
  ADD KEY `fk_pap_process_pap_process_cat1_idx` (`process_cat_id`);

--
-- Indexes for table `pap_process_cat`
--
ALTER TABLE `pap_process_cat`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pap_process_meta`
--
ALTER TABLE `pap_process_meta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_process_meta_pap_process1_idx` (`process_id`);

--
-- Indexes for table `pap_process_po`
--
ALTER TABLE `pap_process_po`
  ADD PRIMARY KEY (`po_id`),
  ADD KEY `fk_pap_mat_po_pap_user1_idx` (`user_id`),
  ADD KEY `fk_pap_process_po_pap_supplier1_idx` (`supplier_id`);

--
-- Indexes for table `pap_pro_po_dt`
--
ALTER TABLE `pap_pro_po_dt`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_pro_po_dt_pap_process_po1_idx` (`po_id`),
  ADD KEY `fk_pap_pro_po_dt_pap_process1_idx` (`process_id`);

--
-- Indexes for table `pap_quotation`
--
ALTER TABLE `pap_quotation`
  ADD PRIMARY KEY (`quote_id`),
  ADD KEY `fk_pap_quotation_pap_user1_idx` (`user_id`),
  ADD KEY `fk_pap_quotation_pap_customer1_idx` (`customer_id`),
  ADD KEY `fk_pap_quotation_pap_size1_idx` (`job_size_id`);

--
-- Indexes for table `pap_quote_comp`
--
ALTER TABLE `pap_quote_comp`
  ADD KEY `fk_pap_quote_comp_pap_quotation1_idx` (`quote_id`),
  ADD KEY `fk_pap_quote_comp_pap_process1_idx` (`comp_print_id`);

--
-- Indexes for table `pap_quote_meta`
--
ALTER TABLE `pap_quote_meta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_quote_meta_pap_quotation1_idx` (`quote_id`);

--
-- Indexes for table `pap_rc`
--
ALTER TABLE `pap_rc`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_rc_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_rc_dt`
--
ALTER TABLE `pap_rc_dt`
  ADD PRIMARY KEY (`rc_id`,`invoice_id`),
  ADD KEY `fk_pap_invoice_has_pap_rc_pap_rc1_idx` (`rc_id`),
  ADD KEY `fk_pap_invoice_has_pap_rc_pap_invoice1_idx` (`invoice_id`);

--
-- Indexes for table `pap_requisition`
--
ALTER TABLE `pap_requisition`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_requisition_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_req_dt`
--
ALTER TABLE `pap_req_dt`
  ADD PRIMARY KEY (`req_id`,`qty`),
  ADD KEY `fk_pap_req_dt_pap_requisition1_idx` (`req_id`),
  ADD KEY `fk_pap_req_dt_pap_mat1_idx` (`mat_id`);

--
-- Indexes for table `pap_sale_cus`
--
ALTER TABLE `pap_sale_cus`
  ADD PRIMARY KEY (`user_id`,`cus_id`),
  ADD KEY `fk_pap_user_has_pap_customer_pap_customer1_idx` (`cus_id`),
  ADD KEY `fk_pap_user_has_pap_customer_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_size`
--
ALTER TABLE `pap_size`
  ADD PRIMARY KEY (`size_id`);

--
-- Indexes for table `pap_supplier`
--
ALTER TABLE `pap_supplier`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pap_supplier_cat`
--
ALTER TABLE `pap_supplier_cat`
  ADD PRIMARY KEY (`tax_id`,`supplier_id`),
  ADD KEY `fk_pap_term_tax_has_pap_supplier_pap_supplier1_idx` (`supplier_id`),
  ADD KEY `fk_pap_term_tax_has_pap_supplier_pap_term_tax1_idx` (`tax_id`);

--
-- Indexes for table `pap_supplier_ct`
--
ALTER TABLE `pap_supplier_ct`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_supplier_ct_pap_supplier1_idx` (`supplier_id`);

--
-- Indexes for table `pap_temp_deli`
--
ALTER TABLE `pap_temp_deli`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_temp_deli_pap_delivery1_idx` (`deli_id`),
  ADD KEY `fk_pap_temp_deli_pap_contact1_idx` (`contact`);

--
-- Indexes for table `pap_temp_dt`
--
ALTER TABLE `pap_temp_dt`
  ADD KEY `fk_pap_temp_dt_pap_temp_deli1_idx` (`temp_deli_id`);

--
-- Indexes for table `pap_term`
--
ALTER TABLE `pap_term`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pap_term_tax`
--
ALTER TABLE `pap_term_tax`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_term_tax_pap_term1_idx` (`term_id`);

--
-- Indexes for table `pap_user`
--
ALTER TABLE `pap_user`
  ADD PRIMARY KEY (`user_id`),
  ADD UNIQUE KEY `user_login_UNIQUE` (`user_login`),
  ADD UNIQUE KEY `user_email_UNIQUE` (`user_email`);

--
-- Indexes for table `pap_usermeta`
--
ALTER TABLE `pap_usermeta`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_usermeta_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_wip_delivery`
--
ALTER TABLE `pap_wip_delivery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_pap_wip_delivery_pap_process_po1_idx` (`po_id`),
  ADD KEY `fk_pap_wip_delivery_pap_user1_idx` (`user_id`);

--
-- Indexes for table `pap_wip_delivery_dt`
--
ALTER TABLE `pap_wip_delivery_dt`
  ADD PRIMARY KEY (`delivery_id`,`dt_id`),
  ADD KEY `fk_pap_wip_delivery_dt_pap_wip_delivery1_idx` (`delivery_id`),
  ADD KEY `fk_pap_wip_delivery_dt_pap_pro_po_dt1_idx` (`dt_id`);
...
--
-- AUTO_INCREMENT for table `pap_comp_process`
--
ALTER TABLE `pap_comp_process`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT for table `pap_contact`
--
ALTER TABLE `pap_contact`
  MODIFY `contact_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `pap_crm`
--
ALTER TABLE `pap_crm`
  MODIFY `crm_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `pap_customer`
--
ALTER TABLE `pap_customer`
  MODIFY `customer_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `pap_customer_meta`
--
ALTER TABLE `pap_customer_meta`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
-- AUTO_INCREMENT for table `pap_cus_ad`
--
ALTER TABLE `pap_cus_ad`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `pap_delivery`
--
ALTER TABLE `pap_delivery`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_invoice`
--
ALTER TABLE `pap_invoice`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pap_log`
--
ALTER TABLE `pap_log`
  MODIFY `id` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
-- AUTO_INCREMENT for table `pap_machine`
--
ALTER TABLE `pap_machine`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `pap_mat`
--
ALTER TABLE `pap_mat`
  MODIFY `mat_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
--
-- AUTO_INCREMENT for table `pap_matmeta`
--
ALTER TABLE `pap_matmeta`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
-- AUTO_INCREMENT for table `pap_mat_delivery`
--
ALTER TABLE `pap_mat_delivery`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pap_mat_po`
--
ALTER TABLE `pap_mat_po`
  MODIFY `po_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `pap_mat_po_detail`
--
ALTER TABLE `pap_mat_po_detail`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_mat_stk`
--
ALTER TABLE `pap_mat_stk`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pap_option`
--
ALTER TABLE `pap_option`
  MODIFY `op_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
--
-- AUTO_INCREMENT for table `pap_order`
--
ALTER TABLE `pap_order`
  MODIFY `order_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_order_comp`
--
ALTER TABLE `pap_order_comp`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pap_pbill`
--
ALTER TABLE `pap_pbill`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_process`
--
ALTER TABLE `pap_process`
  MODIFY `process_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `pap_process_cat`
--
ALTER TABLE `pap_process_cat`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
-- AUTO_INCREMENT for table `pap_process_meta`
--
ALTER TABLE `pap_process_meta`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=211;
--
-- AUTO_INCREMENT for table `pap_process_po`
--
ALTER TABLE `pap_process_po`
  MODIFY `po_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_pro_po_dt`
--
ALTER TABLE `pap_pro_po_dt`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `pap_quotation`
--
ALTER TABLE `pap_quotation`
  MODIFY `quote_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pap_quote_meta`
--
ALTER TABLE `pap_quote_meta`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
--
-- AUTO_INCREMENT for table `pap_rc`
--
ALTER TABLE `pap_rc`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pap_requisition`
--
ALTER TABLE `pap_requisition`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `pap_size`
--
ALTER TABLE `pap_size`
  MODIFY `size_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `pap_supplier`
--
ALTER TABLE `pap_supplier`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `pap_supplier_ct`
--
ALTER TABLE `pap_supplier_ct`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `pap_temp_deli`
--
ALTER TABLE `pap_temp_deli`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `pap_term`
--
ALTER TABLE `pap_term`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `pap_term_tax`
--
ALTER TABLE `pap_term_tax`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
-- AUTO_INCREMENT for table `pap_user`
--
ALTER TABLE `pap_user`
  MODIFY `user_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
-- AUTO_INCREMENT for table `pap_usermeta`
--
ALTER TABLE `pap_usermeta`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `pap_wip_delivery`
--
ALTER TABLE `pap_wip_delivery`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
